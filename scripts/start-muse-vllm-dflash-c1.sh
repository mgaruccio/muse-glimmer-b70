#!/bin/bash
# GPTQ target + BF16 DFlash assistant, eager (no XPU graphs).
set -euo pipefail
...
: "${DRAFT:?Set DRAFT to the BF16 DFlash assistant directory}"
SPEC="${SPEC:-$ROOT/muse-dflash-spec.json}"
